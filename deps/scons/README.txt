...
# /home/scons/scons/branch.0/branch.96/baseline/src/README.txt 0.96.96.D001 2007/04/12 14:12:18 knight
...
In this case, your options are:
    ...
    --  (Recommended.)  Install from a pre-packaged SCons package that
        does not require distutils:
            ...
            Red Hat Linux       scons-0.96.96-1.noarch.rpm

            Debian GNU/Linux    scons_0.96.96-1_all.deb
                                (or use apt-get)
