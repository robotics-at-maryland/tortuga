...
TEXTWIDGET_SIZE Size(0.19, 0.06)
NUMBERWIDGET_SIZE Size(0.065, 0.06)
SCROLLWIDGET_SIZE Size(0.21, 0.02)

TEXTWIDGET_XPOS 0.01
NUMBERWIDGET_XPOS 0.37
SCROLLWIDGET_XPOS 0.50

TEXTWIDGET_YADJUST (-0.05f)
WIDGET_YSTART 0.2f
WIDGET_YOFFSET 0.15f
...
class OceanDemo:
    ...
    def __init__(self):
        ...
        self.mLights = []        
        self.mLightFlareSets = []        
        self.mLightPositions = []
        self.mLightPositions.append(ogre.Vector3(00, 400, 00))
        self.mLightRotationAngles = []
        self.mLightRotationAngles(35)
        self.mLightRotationAxes = []
        self.mLightRotationAxes.append(ogre.Vector3(1, 0, 0))
        self.mLightmLightSpeeds = []
        self.mLightSpeeds.append(30)
        self.mDiffuseLightColours = []
        self.mDiffuseLightColours.append(ogre.ColourValue(0.6, 0.6, 0.6))
        self.mSpecularLightColours = []
        self.mSpecularLightColours.append(ogre.ColourValue(0.5, 0.5, 0.5))
        self.mLightState = []
        self.mLightState.append(True)

        self.mLightNodes = []
        self.mLightPivots = []
        
        # Shared Pointers
        self.mActiveFragmentProgram = 0
        self.mActiveFragmentParameters = 0
        self.mActiveVertexProgram = 0
        self.mActiveVertexParameters = 0
        self.mActiveMaterial = 0
    ...
    def __del__(self):
        ...
        self.mActiveFragmentProgram.setNull()
        self.mActiveFragmentParameters.setNull()
        self.mActiveVertexProgram.setNull()
        self.mActiveVertexParameters.setNull()
        self.mActiveMaterial.setNull()
        del self.root
    ...
    def setup(self):
        ...
        self.loadAllMaterialControlFiles(mMaterialControlsContainer)
	    self.initDemoEventWiring()
	    self.initComboBoxes()
	    return True
    ...
    def _createViewports(self):
        ...
        w = self.viewport.actualWidth*1.0
        h = self.viewport.actualHeight*1.0
