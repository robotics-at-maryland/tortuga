...
OSStatus MouseMoveWrapper( EventHandlerCallRef nextHandler, EventRef theEvent, void* callClass );

OSStatus MouseButtonWrapper( EventHandlerCallRef nextHandler, EventRef theEvent, void* callClass );

OSStatus MouseScrollWrapper( EventHandlerCallRef nextHandler, EventRef theEvent, void* callClass );
...
namespace OIS
{
    ...
    private:
        Mac_MouseStackEvent( MacEventType type, unsigned int time ) : Type(type), Time(time) {}
