...
#include "fixed.h"
#include "/home/levashom/auv/trunk/packages/math/include/MatrixN.h"
#include "/home/levashom/auv/trunk/packages/math/include/Vector3.h"
...
int main(int argc, char* argv[])
{
    ...
    //int i=-1;
    //while(fread(sample,sizeof(adcdata_t),NCHANNELS,dfile)==(size_t)NCHANNELS)
    //{
        //i++;
