...
Rather than move the source, it may be simpler to rotate the hydrophone array.  We can use the AUV itself as a precision \(4 \pi\) steradians underwater rotation stage for the calibration process.
