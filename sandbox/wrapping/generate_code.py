...
mb = module_builder.module_builder_t(
        files=['include/Vehicle.h', 'include/PSU.h', 'include/Device.h'],
        indexing_suite_version=2)

# Set the call policy so Python doesn't take control of object
mem_fun = mb.class_('Vehicle').member_function( 'getDevices')
...
mb.build_code_creator( module_name='vehicle' )
...
mb.write_module( os.path.join( os.path.abspath('.'), 'wrappers/generated.cpp' ) )
