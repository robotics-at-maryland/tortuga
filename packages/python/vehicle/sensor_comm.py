...
class communicator:
    ...
    def __init__(self, serial_device):
        self.commands = {"lcdtop":[0x0c,0x00],
                         "lcdbottom":[0x0c,0x01],
                         "ping":[0x00,0x00],
                         "check":[0x01,0x01],
                         "depth":[0x02,0x02],
                         "synchronize":[0xff],
                         "status":[0x04,0x04],
                         "hardkill":[0x06,0xde,0xad,0xbe,0xef,0x3e],
                         "marker0":[0x07,0x00,0x07],
                         "marker1":[0x07,0x01,0x08],
                         "display_off":[0x08,0x00,0x08],
                         "display_on":[0x08,0x01,0x09],
                         "display_blink":[0x08,0x02,0x0a],
                         "thruster0off":[0x09,0xb1,0xd0,0x23,0x7a,0x69,0x00,0x90],
                         "thruster1off":[0x09,0xb1,0xd0,0x23,0x7a,0x69,0x01,0x91],
                         "thruster2off":[0x09,0xb1,0xd0,0x23,0x7a,0x69,0x02,0x92],
                         "thruster3off":[0x09,0xb1,0xd0,0x23,0x7a,0x69,0x03,0x93],
                         "thruster0on":[0x09,0xb1,0xd0,0x23,0x7a,0x69,0x04,0x94],
                         "thruster1on":[0x09,0xb1,0xd0,0x23,0x7a,0x69,0x05,0x95],
                         "thruster2on":[0x09,0xb1,0xd0,0x23,0x7a,0x69,0x06,0x96],
                         "thruster3on":[0x09,0xb1,0xd0,0x23,0x7a,0x69,0x07,0x97]}
        self.response_commands = {"success":[0xbc],
                                  "checksum_fail":[0xcc],
                                  "failure":[0xdf],
                                  "depth":[0x03],
                                  "synchronize":[0xbc],
                                  "status":[0x05]}
        self.response_lengths = {"depth":4,
                                 "check":1,
                                 "ping":1,
                                 "depth":4,
                                 "synchronize":1,
        ...
        try:
            self.ser = serial.Serial(serial_device,115200,timeout=1)
            self.init = True
        except:
