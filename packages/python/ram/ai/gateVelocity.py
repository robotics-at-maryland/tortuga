...
class FindGate(state.State):
    ...
    def enter(self):
        ...
        self.motionManager._controller.moveVel(0.3,0,0)
        self.brek = self.timerManager.newTimer(motion.basic.MotionManager.FINISHED, 85)
        self.brek.start()
    ...
    def HOLD(self, event):
        ...
        self.timer = self.timerManager.newTimer(HOLD, 0.1)
        self.timer.start()
