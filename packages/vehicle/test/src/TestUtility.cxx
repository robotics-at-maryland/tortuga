...
{
    // Vehicle pictched downward 45 degrees
    ...
    math::Quaternion result(
        vehicle::Utility::quaternionFromMagAccel(mag, accel));
    CHECK_CLOSE(expectedOrientation, result, 0.0001);


    // Vehicle rotated 45 degrees left
    ...
    math::Quaternion result2(
        vehicle::Utility::quaternionFromMagAccel(mag2, accel2));
    CHECK_CLOSE(expectedOrientation2, result2, 0.0001);

    // Vehicle rolled 45 degrees right
    ...
    math::Quaternion result3(
        vehicle::Utility::quaternionFromMagAccel(mag3, accel3));
