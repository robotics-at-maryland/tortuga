...
void SensorBoard::update(double timestep)
{
    ...
    double depth = 0;
    {
        ...
        //begin added commands 7-25-2013 by Eliot
        //this is in line with prescribed comments from sensorapi.h
        //a 3ms sleep was chosen to be sure, a 2ms average time is expected
        usleep(3000);
        //readSpeedResponses(m_deviceFD);
        //additions currently commented, commands may have blocked thrusters
        //someone's outputting debug statements in readSpeedResponses
        //end added commands
