...
#ifndef RAM_ESTIMATION_PARTICLEVISIONESTIMATIONMODULE_H
#define RAM_ESTIMATION_PARTICLEVISIONESTIMATIONMODULE_H
 ...
 * of getting an accurate estimate of the obstacle position.
 *
 * Fail-Safe
...
class ParticleVisionEstimationModule : public EstimationModule
{
public:
    ParticleVisionEstimationModule(core::ConfigNode config,
                                 core::EventHubPtr eventHub,
                                 EstimatedStatePtr estState,
                                 Obstacle::ObstacleType obstacle,
                                 core::Event::EventType inputEventType);

    virtual ~ParticleVisionEstimationModule(){};
...
#endif // RAM_ESTIMATION_PARTICLEVISIONESTIMATIONMODULE_H
