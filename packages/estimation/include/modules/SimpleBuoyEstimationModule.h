...
#ifndef RAM_ESTIMATION_SIMPLEBUOYESTIMATIONMODULE_H
#define RAM_ESTIMATION_SIMPLEBUOYESTIMATIONMODULE_H
...
class SimpleBuoyEstimationModule : public EstimationModule
{
public:
    SimpleBuoyEstimationModule(core::ConfigNode config,
                               core::EventHubPtr eventHub,
                               EstimatedStatePtr estState,
                               Obstacle::ObstacleType obstacle,
                               core::Event::EventType inputEventType);

    virtual ~SimpleBuoyEstimationModule() {};
...
private:
    ...
    std::deque<math::Vector3> m_buoyMeasurements;
};
...
#endif // RAM_ESTIMATION_SIMPLEBUOYESTIMATIONMODULE_H
