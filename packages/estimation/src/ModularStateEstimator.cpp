                                 ...
                                 core::EventHubPtr eventHub)
{
    ...
    if(config.exists("LargeHeart") && config.exists("SmallHeart"))
    {
        addObstacle(config["LargeHeart"], Obstacle::LARGE_HEART);
        addObstacle(config["SmallHeart"], Obstacle::SMALL_HEART);

        modules.push_back(
            EstimationModulePtr(new SimpleCupidEstimationModule(
                                    config["CupidEstimationModule"],
                                    eventHub,
                                    m_estimatedState,
                                    Obstacle::CUPID,
                                    vision::EventType::CUPID_FOUND)));
