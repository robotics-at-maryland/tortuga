 ...
 * Copyright (C) 2012 Jonathan Wonders
 * All rights reserved.
 *
 * Author: Gary Sullivan <gsulliva@umd.edu>
 * File:  packages/vision/include/CaesarDetector.h
 */

#ifndef RAM_CAESAR_WINDOW_DETECTOR_H
#define RAM_CAESAR_WINDOW_DETECTOR_H
...
class RAM_EXPORT CaesarDetector : public Detector
{
  public:
    CaesarDetector(core::ConfigNode config,
                   core::EventHubPtr eventHub = core::EventHubPtr());
    CaesarDetector(Camera* camera);
    ~CaesarDetector();
  ...
  private:
    ...
    double m_minHoleAspectRatio;
    double m_maxHoleAspectRatio;

    // double m_minLargeHoleRelativeWidth;
    // double m_maxLargeHoleRelativeWidth;

    // double m_minSmallHoleRelativeWidth;
    // double m_maxSmallHoleRelativeWidth;

    double m_minHolePixelPct;
...
#endif // RAM_CAESAR_WINDOW_DETECTOR_H
