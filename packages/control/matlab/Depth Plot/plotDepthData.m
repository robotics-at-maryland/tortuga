...
control_signal = a(offset+4:end,24)*1000;
...
result = zeros(1,5);
[result(1) result(2) result(3) result(4) result(5)] = FindStepInfo(t,depth_a,i,depth_start,depth_d,0.02);

% plots measured and desired depth
subplot(2,1,1);
hold on
plot(t,depth_a,color,'LineWidth',2);
set(gca,'YDir','reverse')
hold off
subplot(2,1,2);
hold on
plot(t,control_signal,color,'LineWidth',2);
set(gca,'YDir','reverse')
hold off
%plot(t(i),depth_a(i),'*')
...
%stepinfo(depth_a,t,5,'SettlingTimeThreshold',0.05)
end
