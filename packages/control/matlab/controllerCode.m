...
realPosition=zeros(3,numSimPoints);
realVelocity=zeros(3,numSimPoints);
realQuaternion=[zeros(3,numSimPoints); ones(1,numSimPoints)];
realAngularRate=zeros(3,numSimPoints);
realEstimatedParameters=zeros(6,numSimPoints);

%initialize storage arrays for plotting
realPosition(3,1)=MeasuredState.depth;
realQuaternion(:,1)=MeasuredState.quaternion;
realAngularRate(:,1)=MeasuredState.angularRate;
realEstimatedParameters(:,1)=ControllerState.inertiaEstimate;


%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%simulation loop%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
for index=1:1:numSimPoints
