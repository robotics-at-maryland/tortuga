...
%  process
[       a              time_low_freq    depth_measured_low_freq          d     ] = DepthEstimationSamplingRateComparison(60);
[true_measured_depth   time_high_freq   depth_measured_high_freq    x_hat_array] = DepthEstimationSamplingRateComparison(10000);
...
subplot(3,1,1)
plot(time_high_freq,true_measured_depth(1,:),'*r',time_low_freq,depth_measured_low_freq(1,:),'g',time_high_freq,x_hat_array(1,:),':b','LineWidth',1)
...
%x_hat_array(2,:)
subplot(3,1,2)
plot(time_high_freq,true_measured_depth(2,:),'*r',time_low_freq,depth_measured_low_freq(2,:) ,'g',time_high_freq,depth_measured_high_freq,':b','LineWidth',1)
set(gca,'YDir','reverse')
...
subplot(3,1,3)
plot(time_high_freq,true_measured_depth(2,:),'*r',time_low_freq,depth_measured_low_freq(2,:),'g','LineWidth',1)
set(gca,'YDir','reverse')
