function [s,v] = SVAJ_generator(deltat, act_depth,des_depth,total_time)
...
%total_time2 = 35/32*change_in_depth/vel_max;
...
step=step+1;
s(step) = (change_in_depth)*  (35*               (current_time/total_time)^4  -84*               (current_time/total_time)^5  +70*               (current_time/total_time)^6 -20*               (current_time/total_time)^7); %+act_depth;
v(step) = (change_in_depth)*  (35*4*(1/total_time)*(current_time/total_time)^3  -84*5*(1/total_time)*(current_time/total_time)^4  +70*6*(1/total_time)*(current_time/total_time)^5 -20*7*(1/total_time)*(current_time/total_time)^6);
end
