...
// {
//   estimator->estOrientation = math::Quaternion(0,0,0,1);
//   estimator->estAngularRate = math::Vector3(0,0,5);
...
//     // Make sure once we leave, and come back it will go off again
//     estimator->estOrientation = math::Quaternion(math::Degree(30),
//                                                  math::Vector3::UNIT_Z);;
//     controller.update(1);
//     CHECK_EQUAL(math::Quaternion::IDENTITY, actualOrientation);

//     estimator->estOrientation = math::Quaternion(math::Degree(15),
//                                             math::Vector3::UNIT_Z);
//     controller.update(1);
//     CHECK_EQUAL(orientation, actualOrientation);
// }
